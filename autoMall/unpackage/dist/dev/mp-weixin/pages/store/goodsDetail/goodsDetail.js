...
var _goodsDetail = _interopRequireDefault(__webpack_require__(/*! ./pages/store/goodsDetail/goodsDetail.vue */ 132));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/* harmony import */ var _goodsDetail_vue_vue_type_template_id_68223f28_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./goodsDetail.vue?vue&type=template&id=68223f28&scoped=true& */ 133);
/* harmony import */ var _goodsDetail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./goodsDetail.vue?vue&type=script&lang=js& */ 135);
...
/* harmony import */ var _goodsDetail_vue_vue_type_style_index_0_id_68223f28_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./goodsDetail.vue?vue&type=style&index=0&id=68223f28&lang=scss&scoped=true& */ 137);
...
var _store = __webpack_require__(/*! @/api/store.js */ 43);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var _uniPopupMessage = function _uniPopupMessage() {Promise.all(/*! require.ensure | node-modules/@dcloudio/uni-ui/lib/uni-popup-message/uni-popup-message */[__webpack_require__.e("common/vendor"), __webpack_require__.e("node-modules/@dcloudio/uni-ui/lib/uni-popup-message/uni-popup-message")]).then((function () {return resolve(__webpack_require__(/*! @dcloudio/uni-ui/lib/uni-popup-message/uni-popup-message */ 451));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _uniNumberBox = function _uniNumberBox() {__webpack_require__.e(/*! require.ensure | node-modules/@dcloudio/uni-ui/lib/uni-number-box/uni-number-box */ "node-modules/@dcloudio/uni-ui/lib/uni-number-box/uni-number-box").then((function () {return resolve(__webpack_require__(/*! @dcloudio/uni-ui/lib/uni-number-box/uni-number-box */ 459));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _uniPopup = function _uniPopup() {__webpack_require__.e(/*! require.ensure | node-modules/@dcloudio/uni-ui/lib/uni-popup/uni-popup */ "node-modules/@dcloudio/uni-ui/lib/uni-popup/uni-popup").then((function () {return resolve(__webpack_require__(/*! @dcloudio/uni-ui/lib/uni-popup/uni-popup */ 466));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =

{
  ...
  methods: {
    initgoods: function initgoods(e) {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var that, data;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                that = _this;_context.next = 3;return (
                  (0, _store.goodsDetail)({ goods_id: e }));case 3:data = _context.sent;
                console.log(data);
                ...
                that.skuList.forEach(function (attr) {
                  var temp = {
                    name: attr.name };

                  temp.child = attr.child.map(function (item) {
                    return {
                      name: item.name,
                      actived: false,
                      disabled: false,
                ...
                that.sku_price = data.data.sku_price;case 17:case "end":return _context.stop();}}}, _callee);}))();
    },
    ...
    //选择规格
    changecTab: function changecTab(key, key2) {
      var that = this;
      that.selectSku = [];
      console.log(key, key2, that.process_attribute, '666');
      if (!that.process_attribute[key].child[key2].disabled) {
        that.process_attribute[key].child.forEach(function (item, index) {
          item.actived = index == key2 ? !item.actived : false;
        });
      }
      that.process_attribute.forEach(function (item, index) {
        var selectData = item.child.filter(function (e) {
    ...
    getPrice: function getPrice() {
      var that = this;
      var data = that.sku_price.filter(function (res) {
        console.log(res);
    ...
    toCoup: function toCoup() {var _this2 = this;
      var query;
      if (this.goodsType === 1) {
        query = {
    ...
    addCart: function addCart(e) {
      ...
      if (e === '收藏') {
        ...
        (0, _store.addShopCart)(query).then(function (res) {
          uni.showToast({
            title: '加入购物车成功',
            icon: 'none',
            duration: 2000 });
